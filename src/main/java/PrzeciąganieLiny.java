...
public class PrzeciąganieLiny extends Spotkanie {

    public PrzeciąganieLiny(TablicaDrużyn tabD, TablicaSędziów tabS) {
        super(tabD, tabS);
    }

    public void zapisz() throws FileNotFoundException {
        PrintWriter zapis = new PrintWriter("./src/main/resources/WynikiPrzeciaganieLiny.txt");
        int l=0;
